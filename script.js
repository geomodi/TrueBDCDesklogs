  ...
  if (dealership.recordId) {
    ...
    fetch(apiUrl, {
      ...
      .then(data => {
        ...
        const internet = parseInt(record['Internet']) || 0; // Fetch "Internet" data
        const remainingToday = parseInt(record['Remaining Today']) || 0; // Fetch "Remaining Today" data
        ...
        Highcharts.chart(chartId, {
          ...
          xAxis: {
            categories: ['Confirmed', 'Shown', 'Missed', 'Overdue', 'Today', 'Tomorrow', '3rd Day', 'TrueBDC Today', 'Internet', 'Remaining Today'], // Update the categories array
            title: {
              text: null
            }
          },
          ...
          series: [{
            name: 'Desklog Data',
            data: [confirmed, shown, missed, overdue, apptsToday, apptsTomorrow, appts3rdDay, trueBDCToday, internet, remainingToday] // Update the data array
          }],
          legend: {
            enabled: true
          },
